...
model = UNet2D(down_block_types=("DownBlock2D", "DownBlock2D", "DownBlock2D", "AttnDownBlock2D"),
...
master_model = MasterModel(model=model.model,
                           ...
                           stub_path="stubs/diffusion-pistachio-32/experiment-1-0")
master_model.train(save_name="experiment-1-0")
